document.addEventListener("DOMContentLoaded", function () {
    ...
    // aqui la primera parte bucle para listar todos las generaciones en botones radio de checked
    // estos son solo los botones de seleccion generacion
    // y 
    var geners = [
      "generation-1",
      "generation-2",
    ...
    // obtenemos la parte que vamos a afectar
    var filters = document.getElementById("filters");
    var gen = "";
    // recorremos un bucle para crear un input y un label por cada string del array
